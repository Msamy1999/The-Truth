...
export function AnalyticsConsentBanner() {
  ...
  return (
    <aside
      ...
      className="fixed inset-x-3 bottom-3 z-[70] mx-auto max-w-2xl rounded-lg border border-border bg-card p-3 text-sm text-card-foreground shadow-soft sm:inset-x-6 sm:flex sm:items-center sm:gap-4 print:hidden"
    >
