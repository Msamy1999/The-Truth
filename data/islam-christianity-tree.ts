  ...
  branch(
    ...
    [
      ...
      planned(
        ...
        "/jesus",
        "Planned source-pending study with exact Quran and Bible passages added only after verification.",
      ),
      planned("The miracles of Jesus", "/jesus"),
      topic(
      ...
      planned("Did Jesus claim to be God?", "/jesus"),
      planned(
        "Jesus and the Trinity",
        "/jesus",
        "Planned bridge into Tawhid, Trinity, incarnation, and worship.",
      ),
      planned("Jesus as Messiah", "/jesus"),
      planned("The crucifixion question", "/jesus"),
      planned("The second coming of Jesus", "/jesus"),
      topic(
