...
export const islamChristianityBranches: IslamChristianityBranchDef[] = [
  ...
  branch(
    ...
    [
      ...
      topic(
        ...
        "The Incarnation explained: how Christians understand God becoming man, and the Islamic response.",
        "draft",
      ),
      topic(
        "Jesus as Messiah",
      ...
      topic(
        "The divinity verses examined one by one",
        "/articles/the-divinity-verses-examined",
        "John 1:1, 8:58, 10:30, 20:28, and four Pauline texts, each with the Trinitarian and unitarian readings.",
        "draft",
      ),
    ],
    { defaultOpen: true },
  ...
  branch("preservation", [
    ...
    topic(
      ...
      "/articles/when-was-deuteronomy-written",
      "The scholarly consensus on Deuteronomy's dating, and what a scripture's composition history means for its authority.",
      "draft",
    ),
    topic(
      "Pseudepigrapha in the New Testament",
      "/articles/pseudepigrapha-in-the-new-testament",
      "What mainstream scholarship says about books written in someone else's name, especially 2 Peter.",
      "draft",
    ),
  ]),
  ...
  branch("war-and-violence", [
    ...
    topic(
      "Civilian protection in Islamic law and the Biblical tradition",
      "/articles/civilian-protection-in-war",
      "Who may be fought and who may never be targeted, in Islamic jurisprudence and the Biblical herem texts.",
      "draft",
    ),
    topic(
      "The rights of non-Muslims under Islamic law",
      "/articles/rights-of-non-muslims",
      "What Islamic law guarantees non-Muslims in life, property, worship, and legal protection.",
      "draft",
    ),
  ]),
  branch("women", [
    ...
    topic(
      "Eve in Islam and Christianity",
      "/articles/eve-in-islam-and-christianity",
      "How the two traditions read Eve and the fall, and what follows for all women.",
      "draft",
    ),
    topic(
      "Women's worth: classical Christian voices and the Islamic tradition",
      "/articles/womens-worth-classical-voices",
      "Tertullian, Jerome, Aquinas, and Basil on women, alongside the Islamic textual tradition and modern responses.",
      "draft",
    ),
  ]),
  branch("historical-evidence", [
    ...
    topic(
      "James, Josephus, and the earliest external evidence",
      "/articles/james-josephus-and-external-evidence",
      "What Josephus's Testimonium and James passages actually say, and what the authenticity debate shows.",
      "draft",
    ),
    topic(
      "The crucifixion and history: how strong is the evidence?",
      "/articles/the-crucifixion-and-history",
      "A methodological audit of what historians can and cannot establish about the crucifixion.",
      "draft",
    ),
  ]),
  branch("prophecies", [
  ...
  branch("scientific-signs", [
    ...
    topic(
      "Celestial signs: orbits, stars, iron, and light in the Quran",
      "/articles/celestial-signs-in-the-quran",
      "Orbits, star positions, plant pairs, iron, and moonlight, each honestly graded strong, flexible, or overclaimed.",
      "draft",
    ),
  ]),
  branch("difficult-questions", [
      ...
      children: [
        {
          ...
          children: [
            topic(
              "Creation sequence and the creation of woman",
              "/articles/contradictions-in-the-bible#creation-accounts",
              "Genesis 1 presents male and female together after the living creatures; Genesis 2 narrates the man, the garden and animals, then the woman. Critics see conflicting sequence; interpreters read Genesis 2 as a topical close-up rather than a second timeline.",
              "draft",
              "Narrative",
            ),
            topic(
              "Animals on Noah's ark",
              "/articles/contradictions-in-the-bible#ark-instructions",
              "Genesis 6 says two of every kind, while Genesis 7 requires seven pairs of clean animals and birds. It is a tension only if both are read as the same complete instruction; the usual harmonization treats the later command as an addition for clean animals.",
              "draft",
              "Numbers",
            ),
            topic(
              "Who incited David's census?",
              "/articles/contradictions-in-the-bible#davids-census",
              "2 Samuel names the LORD as the mover of David; 1 Chronicles names Satan. The same act has two named agents, so critics see a direct contradiction; Christian harmonizations appeal to divine permission and secondary agency.",
              "draft",
              "History",
            ),
            topic(
              ...
              "Matthew names Jacob as Joseph's father and traces David's line through Solomon; Luke names Heli and traces it through Nathan. The lists diverge at many points, so they cannot both be one simple biological genealogy without an additional explanation.",
              "draft",
              "Gospels",
            ),
            topic(
              "Judas's death and the Field of Blood",
              "/articles/the-death-of-judas",
              "Matthew says Judas hanged himself and the priests bought the field; Acts says Judas acquired it and fell headlong. Critics see different outcomes and purchasers; a common harmonization says the fall followed the hanging and the priests acted with Judas's money.",
              "draft",
              "Acts",
            ),
            topic(
              "Passover and the time of crucifixion",
              "/articles/the-timing-of-the-crucifixion",
              "The Synoptics present the Last Supper as a Passover meal, while John places the trial on the preparation day and still speaks of eating Passover. Critics see incompatible chronology; proposed solutions depend on different calendar or terminology readings.",
              "draft",
              "Passion",
            ),
            topic(
              "Resurrection reports",
              "/articles/contradictions-in-the-bible#resurrection-reports",
              "The Gospels differ over the women named at the tomb, the time of arrival, the messengers, and later locations. These are contradictions if each account is a complete sequence; harmonizers treat several reports as selective accounts of a longer series of events.",
              "draft",
              "Resurrection",
            ),
          ],
    ...
    topic(
      "Why would God allow scripture to be corrupted?",
      "/articles/why-would-god-allow-corruption",
      "The theological objection Muslims raise about textual corruption, and whether it rebounds on the Quran.",
      "draft",
    ),
  ]),
];
